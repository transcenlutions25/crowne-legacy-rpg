...
- [x] Identify the official Crowne Legacy Mobile repository.
- [x] Inspect the verified vertical-slice package.
- [x] Run the local syntax checks.
- [x] Run the local gameplay test suite: 7 of 7 passing.
